...
public class QuizAppControllerTest {
    ...
    public void testControllerHome() throws Exception {
        ...
        yakshaAssert(currentTest(), result.getModelAndView() != null
                ...
                && result.getModelAndView().getViewName().contentEquals("index.html"), businessTestFile);
    }

    @Test
    public void testControllerQuizAndUserNameAsEmpty() throws Exception {
        MvcResult result = this.mockMvc.perform(post("/quiz")
    ...
    public void testControllerSubmit() throws Exception {
        ...
        MvcResult result = this.mockMvc.perform(post("/submit")
                .flashAttr("qForm", questionForm)).andReturn();
        yakshaAssert(currentTest(), result.getModelAndView() != null
                && result.getModelAndView().getViewName() != null
